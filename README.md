...
1.  Os dados econômicos são armazenados em `data/Dadoseconomicos.json`.
2.  O `script.js` carrega esses dados e os apresenta no `index.html`.
3.  Os dados tem o fluxo automático de atualização gerados apartir da api e da conversão pra "Dadoeconomicos.ipca"
...
<p align="center">
  <img src="https://raw.githubusercontent.com/andreasbm/readme/master/assets/lines/rainbow.png" width="100%">
  <img src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExNHJueGZ3bmZqZzRveXp3eHozbmR0bmZ6bmZ6bmZ6bmZ6bmZ6bmZ6JmVwPXYxX2ludGVybmFsX2dpZl9ieV9pZCZjdD1n/l41lTfuxN7u88N7dm/giphy.gif" width="150px">
</p>
